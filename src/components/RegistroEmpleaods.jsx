...
function RegistroEmpleaods() {
    ...
    const rolesList = ["EMPLEADO", "ENCARGADO DE SUCURSAL", "ADMINISTRADOR DE RECURSOS", "GERENTE GENERAL"]
  ...
  return (
    ...
    <div className='formulario-original' id='formulario-original'>
          ...
          <label class="form-label form-label-sm h4">ID EMPLEADO</label>
          <input type="text" id="matricula" name="matricula" className="form-control" value={inputValue2} onChange={handleInputChange2}/>
          <br />
          <br />
          ...
          <br />
          <br />
          <label class="form-label form-label-sm h4">CARGO</label>
          <br />
          <select id="rolesg" name="rolesg" className="form-select">
          ...
          <br />
          <br />
          <label class="form-label form-label-sm h4">SELECCIONA</label>
          <br />
          <input id="archivo" type="file" onChange={seleccionarFoto} className="form-control"/>
          <br />
          <button onClick={agregaAlumnos} className="btn btn-success">AGREGAR </button>
          <br />
        </div>
        <br />
