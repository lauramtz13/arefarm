...
function RegistroProveedores() {
  ...
  return (
    ...
    <div className='formulario-original' id='formulario-original'>
          ...
          <label class="form-label form-label-sm h4">ID PROVEEDOR</label>
        ...
        <form onSubmit={guardarRegistroEditado} id="formulariooculto" className="formulario-oculto">
          ...
          <br />
          <input type="text" name="correoEditar" placeholder="CORREO ELECTRONICO" id="correoEditar" className="form-control"/>
          <br />
