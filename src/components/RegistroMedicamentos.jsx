...
function RegistroMedicamentos() {
  ...
  const categoriasList = ["ANALGÉSICOS", "ANTIÁCIDOS", "ANTIALÉRGICOS", "ANTIDIARREICOS", "ANTIINFECCIOSOS", "ANTIINFLAMATORIOS", "ANTIPIRÉTICOS", "ANTITUSIVOS"]
  const [categorias,setCategorias] = useState(categoriasList)

  const presentacionList = ["CAJA", "BOTELLA", "BOLSA", "CÁPSULAS", "COMPRIMIDOS(PASTILLA)", "JARABES"]
  ...
  return (
    <>
      <div className="formulario-original" id="formulario-original">
        ...
        <label class="form-label form-label-sm h4">ID MEDICAMENTO</label>
        <input type="text" id="clave" name="clave" className="form-control" value={inputValue2} onChange={handleInputChange2}/>
        <br />
        <br />
        <label class="form-label form-label-sm h4">NOMBRE</label>
        ...
        <div class="row g-7">
          <div class="col-auto">
            ...
            <br />
            <input type="submit" onClick={agregarCategorias} value="AGREGAR NUEVA CATEGORIA" className="btn btn-success"/>
            <br />
          </div>
          <div class="col-auto">
            ...
            <br />
            <input type="submit" onClick={agregarPresentacion} value="AGREGAR NUEVA PRESENTACION" className="btn btn-success"/>
            <br />
          </div>
        </div>
        ...
        <br />
        <label class="form-label form-label-sm h4">STOCK MIN</label>
        <input type="text" id="minimo" name="minimo" className="form-control"/>
        <br/>
        <br />
        <label class="form-label form-label-sm h4">STOCK MAX</label>
        <input type="text" id="maximo" name="maximo" className="form-control"/>
        <br />
        <br />
        ...
        <br />
        <button onClick={agregaMedicamento} className="btn btn-success">AGREGAR</button>
        <br />
      </div>
      ...
      <form onSubmit={guardarRegistroEditado} id="formulariooculto" className="formulario-oculto">
          ...
          <div class="row g-7">
          <div class="col-auto">
            <select id="categoriaEditar" name="categoriaEditar" className="form-select custom-input">
                <option value="SELECCION">--SELECCIONAR--</option>
                {categorias.map((item, index) => (
                  <option key={index}>{item}</option>
                ))}
